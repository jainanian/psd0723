...
funcsplit_function_filter_forpattern <- function(x, x_filterchar, x_char_to_filterfinal = c("", "/"), x_numtofilterby = 4, x_funcsplit_coltosearchcol){
# 
  ### troubleshooting
# x<- dftext_sep_not_prefix   %>%
#   filter(
...
funcfindabove_df2_needcorrect_adj_id_need <-   funcfindabove_df2_needcorrect_adj_id  %>% 
      mutate(
        id_nolead2 = lead(id_no), 
        id_nolag2 = lag(id_no)
      ) %>% 
      filter(
        (id_no != id_nolead2)&(id_no != id_nolag2)
      )
...
char_unique <- 
  ...
  ### first M+ (M203), 
   ...
   ### first digit alpha / P digit,  eg 3CB/P6139.PB 
    ...
    splitinto_pattern_MPtop  <-  "[[:digit:]]+[[:alpha:]]+/P[[:digit:]]+|[[:digit:]]+/P[[:digit:]]+|P[[:digit:]]+|[[:digit:]]+$|[[:digit:]]+[[:alpha:cc]]+$"
...
dftext_sep_not_prefix_remainder <- dftext_sep_not_prefix  %>% 
  ...
  funcsplit_function_filter_forpattern(x = ., x_filterchar =splitinto_pattern_MPtop , x_char_to_filterfinal = NULL, x_numtofilterby = 3, x_funcsplit_coltosearchcol= .$text_nospace)
